...
void printmenu()
{
	...
	printf("g- to draw continuosly g again-to erase continuosly g again - to return to normal mode m- to print last 3 drawings\n");
}
